            ...
            <div class="page-utilities">
                <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                    ...
                    <div class="col-auto d-flex align-items-center gap-2">
                        <a class="btn app-btn-secondary" href="{{ route('users.pdf') }}"><i class="fas fa-file-pdf"></i>
                            Exporter en pdf</a>
                        <a href="{{ route('export.users') }}" class="btn app-btn-secondary"><i
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" required name="contact"
                                    placeholder="Entrer le contact..." value="{{ old('contact') }}" pattern="[0-9]{10,15}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('admin.permissions.edit', $user->id) }}"
                                                    class="btn btn-outline-warning border-btn me-4">
                                                        ...
                                                        <form action="/updateUser" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id"
                                                                    value="{{ $user->id }}" id="updateUserId">

                                                                <div class="mb-3">
                                                                    <label class="form-label"><strong
                                                                            class="det">Nom</strong></label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"><strong
                                                                            class="det">Adresse</strong></label>
                                                                    <input type="text" class="form-control"
                                                                        id="updateUserAdresse" name="newAdresse"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"><strong
                                                                            class="det">Contact</strong></label>
                                                                    <input type="tel" class="form-control"
                                                                        id="updateUserContact" name="newContact"
                                                                        placeholder="Entrer le contact..." required
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"><strong
                                                                            class="det">Rôle</strong></label>
                                                                    <select id="updateUserRole" class="form-select"
                                                                        name="newRole" style="color: #5d677c;">
                                                                        <option value="admin"
                                        ...
                                        <div class="modal fade" id="detailsUserModal" tabindex="-1"
                                            aria-labelledby="detailsUserModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="detailsUserModalLabel">Détails de
                                                            l'utilisateur</h5>
                                                    ...
                                                    <div class="modal-body px-md-5">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6"> <span style="font-size: 18px"
                                                                    id="detailsUserName"></span> </div>

                                                            <div class="col-4 det" style="font-size: 18px"> Email : </div>
                                                            <div class="col-6"> <span style="font-size: 18px"
                                                                    id="detailsUserEmail"> </span></div>

                                                            <div class="col-4 det" style="font-size: 18px"> Contact :
                                                            </div>
                                                            <div class="col-6"> <span style="font-size: 18px"
                                                                    id="detailsUserContact"></span> </div>

                                                            <div class="col-4 det" style="font-size: 18px"> Adresse :
                                                            </div>
                                                            <div class="col-6"> <span style="font-size: 18px"
                                                                    id="detailsUserAdresse"></span> </div>

                                                            <div class="col-4 det" style="font-size: 18px"> Rôle : </div>
                                                            <div class="col-6"> <span style="font-size: 18px"
                                                                    id="detailsUserRole"></span> </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            detailsModal.addEventListener('show.bs.modal', function(event) {
                ...
                document.getElementById('detailsUserContact').innerText = button.getAttribute(
                    'data-contact');
                document.getElementById('detailsUserAdresse').innerText = button.getAttribute(
                    'data-adresse');
