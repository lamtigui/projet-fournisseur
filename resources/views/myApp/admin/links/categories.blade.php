                ...
                <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                    ...
                    <div class="col-auto">
                        @if (auth()->user()->role == 'super-admin')
                            <a class="btn app-btn-secondary" href="{{ route('categories.pdf') }}"><i
                                    class="fas fa-file-pdf"></i> Exporter en pdf </a>
                            <a href="{{ route('export.categories') }}" class="btn app-btn-secondary"><i
                                    ...
                                    @foreach ($categories as $categorie)
                                        <tr>
                                            ...
                                            <div class="modal fade" id="ModalCategoryDetail-{{ $categorie->id }}"
                                                tabindex="-1" aria-labelledby="detailsCategoryLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="detailsCategoryLabel">Catégorie
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <!-- Catégorie -->
                                                                <div class="col-4 det" style="font-size: 18px">Catégorie :
                                                                </div>
                                                                <div class="col-6 show-category">
                                                                    <span style="font-size: 18px"
                                                                        id="showCategory-{{ $categorie->id }}"></span>
                                                                </div>

                                                                <div class="col-4 det" style="font-size: 18px;">Les
                                                                    Produits :</div>
